...
{
    internal sealed class WebSocketStreamListener2: IDisposable
    {
        ...
        private readonly string userFriendlyName = nameof(WebSocketStreamListener2);

        public DataStreamStatus WsConnectionStatus { get; private set; } = DataStreamStatus.Closed;


        public WebSocketStreamListener2(KuCoinApiClient apiClient, KuCoinApiClientCredentials credentials)
        {
